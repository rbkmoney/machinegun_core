...
-spec add(options(), tag(), machinegun_core:id(), machinegun_core:request_context(), mg_core_deadline:deadline()) ->
...
-spec replace(options(), tag(), machinegun_core:id(), machinegun_core:request_context(), mg_core_deadline:deadline()) ->
    ok | no_return().
...
-spec process_machine(_, machinegun_core:id(), mg_core_machine:processor_impact(), _, _, _, mg_core_machine:machine_state()) ->
