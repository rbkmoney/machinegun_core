...
-spec store_event(mg_events_machine:options(), machinegun_core:id(), mg_events:event()) ->
    ok.
...
-spec event_to_machine_event(machinegun_core:ns(), machinegun_core:id(), mg_events:event()) ->
    machine_event().
