...
-spec fail(options(), machinegun_core:id(), mg_core_utils:exception(), request_context(), deadline()) ->
    ok.
...
%% retrying
%%
-spec do_with_retry(options(), machinegun_core:id(), fun(() -> R), mg_core_retry:strategy(), request_context(), atom()) ->
    R.
