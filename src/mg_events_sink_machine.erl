...
-spec add_events(options(), machinegun_core:ns(), machinegun_core:id(), [mg_events:event()], ReqCtx, mg_deadline:deadline()) ->
    ok
when
...
-spec get_history(ns_options(), machinegun_core:id(), mg_events:history_range()) ->
    [event()].
...
-spec repair(ns_options(), machinegun_core:id(), machinegun_core:request_context(), mg_deadline:deadline()) ->
    ok.
...
-spec process_machine_(ns_options(), machinegun_core:id(), mg_machine:processor_impact(), state()) ->
    state().
...
-spec get_events_keys(machinegun_core:id(), mg_events:events_range(), mg_events:history_range()) ->
    [mg_storage:key()].
...
-spec generate_sink_events(machinegun_core:ns(), machinegun_core:id(), [mg_events:event()], state()) ->
    {[event()], state()}.
...
-spec generate_sink_event_body(machinegun_core:ns(), machinegun_core:id(), mg_events:event()) ->
    event_body().
...
-spec kvs_to_sink_events(machinegun_core:id(), [mg_storage:kv()]) ->
    [event()].
kvs_to_sink_events(EventSinkID, Kvs) ->
