...
dissect_test(_) ->
    ...
    ?assertEqual({fw(1, 10), undefined}, mg_core_dirange:dissect(fw(1, 10), 42)),
    ?assertEqual({undefined, bw(10, 1)}, mg_core_dirange:dissect(bw(10, 1), 42)),
    ?assertEqual({bw(10, 1), undefined}, mg_core_dirange:dissect(bw(10, 1), 1)),
...
-spec conjoin_test(config()) ->
    _.
conjoin_test(_) ->
    ?assertEqual(fw(1, 10), mg_core_dirange:conjoin(fw(1, 10), undefined)),
    ?assertEqual(fw(1, 10), mg_core_dirange:conjoin(undefined, fw(1, 10))),
...
-spec intersect_test(config()) ->
    _.
intersect_test(_) ->
    ?assertEqual({undefined, undefined, undefined}, mg_core_dirange:intersect(undefined, fw(1, 10))),
    ?assertEqual({bw(10, 7), bw(6, 5), bw(4, 1)}, mg_core_dirange:intersect(bw(10, 1), fw(5, 6))),
    ?assertError(badarg, mg_core_dirange:intersect(fw(1, 10), undefined)),
    ?assert(check_property(
...
-spec fw(T, T) ->
    mg_core_dirange:nonempty_dirange(T).
fw(A, B) ->
